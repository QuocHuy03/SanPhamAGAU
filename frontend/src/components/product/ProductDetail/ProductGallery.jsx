...
const ProductGallery = ({ images }) => {
  ...
  return (
    <div className="flex flex-col space-y-6">
      <div className="group relative aspect-[4/5] w-full overflow-hidden rounded-[2.5rem] bg-white shadow-2xl shadow-indigo-100 ring-1 ring-black/5">
        <img
          key={selectedImage}
          src={images[selectedImage]?.url || images[selectedImage]}
          alt="Main product"
          className="h-full w-full object-cover object-center animate-fade-in transition-all duration-700 group-hover:scale-105"
        />
