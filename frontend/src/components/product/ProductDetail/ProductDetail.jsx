        ...
        <div className="p-8 sm:p-10 lg:p-16 flex flex-col justify-center">
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-6">
                ...
                <span className="text-sm font-bold text-gray-400 border-l-2 border-gray-100 pl-6">
                  {product.reviewCount || 0} {t('product.rating')}
                </span>
            ...
            <div className="pt-8 space-y-6">
              ...
              <div className="flex gap-4">
                <button className="flex-1 h-14 flex items-center justify-center space-x-2 text-[12px] font-black uppercase tracking-widest text-gray-500 hover:text-rose-500 hover:bg-rose-50 rounded-2xl transition-all border border-gray-100 hover:border-rose-100">
                  <FaHeart className="w-4 h-4" />
                  <span>{t('product.wishlist')}</span>
                </button>
                <button className="flex-1 h-14 flex items-center justify-center space-x-2 text-[12px] font-black uppercase tracking-widest text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-2xl transition-all border border-gray-100 hover:border-indigo-100">
